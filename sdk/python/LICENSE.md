...
## Application to NoClick

**Licensed software:** The original NoClick Community source code and SDK code
distributed with this license, excluding third-party components and any file
that carries a different license notice.

**Licensor:** NoClick, Inc. for original NoClick material, and each contributor
for that contributor's contribution.

**Copyright:** © 2025–2026 NoClick, Inc. and contributors.

Third-party components remain under the original licenses provided by their
respective owners. The operative Sustainable Use License, Version 1.0 terms
below are reproduced without modification. This application notice identifies
the licensed software and its licensors; it does not change those terms.
