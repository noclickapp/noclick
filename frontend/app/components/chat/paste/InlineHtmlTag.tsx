    ...
    return (
        <span
            ...
            className={cn(
                ...
                "bg-white/80 rounded-md px-1.5 py-0.5 border border-white/70",
        ...
        >
            <div className="relative flex items-center gap-1">
                ...
                <Code2 className="w-3 h-3 text-zinc-800" />

                <span className="text-xs text-zinc-800 font-mono lowercase">
                    {tagName.toLowerCase()}
                </span>
            </div>
