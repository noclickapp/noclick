// Jira workflow node component.
// Provides issue and project management automation via Jira REST API v3.
// Supports both OAuth 2.0 (3LO) and API token authentication.

import { memo, forwardRef, SVGProps } from 'react';
import { NodeProps } from '@xyflow/react';
import AutomationNode from './base/AutomationNode';
import type { NodeDefinition, SvgIconComponent } from './types';

const DIMENSIONS = { width: 90, height: 90, iconSize: 48 };

// Jira icon SVG (official Atlassian Jira brand)
const JiraIcon: SvgIconComponent = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
...
export const JiraNode: NodeDefinition = {
    type: 'automation-jira',
    label: 'Jira',
    description: 'Jira automation',
    Icon: JiraIcon,
    iconColor: '', // Custom SVG with built-in colors
    dimensions: DIMENSIONS,
    component: memo((props: NodeProps) => (
        <AutomationNode {...props} Icon={JiraIcon} iconColor="" />
    )),
};
