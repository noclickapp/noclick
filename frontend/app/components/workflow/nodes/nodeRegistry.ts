...
function _buildAvailable(): NodeDefinition[] {
    return [
        ...
        MailchimpNode, ResendNode, CalComNode, GoogleMapsNode, PerplexityNode, MailgunNode, GitLabNode, BoxNode, ClickUpNode, DevinNode, AsanaNode, SendEmailNode, AIAgentNode, ToolNode, MCPServerNode,
