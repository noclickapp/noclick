...
function _buildAvailable(): NodeDefinition[] {
    return [
        ...
        MailchimpNode, PipedriveNode, ResendNode, BigQueryNode, ExpensifyNode, LaunchDarklyNode, WebflowNode, PhantomBusterNode, CalComNode, GoogleMapsNode, PerplexityNode, PineconeNode, QdrantNode, UpstashVectorNode, WeaviateNode, ChromaNode, MilvusNode, MongoDBNode, MailgunNode,
        ...
        FirecrawlNode, AttioNode, ZendeskNode, ConfluenceNode, PagerDutyNode, GoogleMeetNode, FreshsalesNode, AppSheetNode, TableauNode, PagespeedNode, GoogleTranslateNode, SendEmailNode, AIAgentNode, ToolNode, MCPServerNode,
        FirecrawlNode, AttioNode, ZendeskNode, ConfluenceNode, PagerDutyNode, GoogleMeetNode, FreshsalesNode, AppSheetNode, TableauNode, PagespeedNode, SnowflakeNode, SendEmailNode, AIAgentNode, ToolNode, MCPServerNode,
