// Telegram automation node definition.
// Uses AutomationNode component with Telegram-specific configuration.
...
const TelegramIcon: SvgIconComponent = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
...
const TelegramNodeComponent = (props: NodeProps) => {
    return (
        <AutomationNode
            {...props}
            Icon={TelegramIcon}
...
export const TelegramNode: NodeDefinition = {
    ...
    component: memo(TelegramNodeComponent),
};
