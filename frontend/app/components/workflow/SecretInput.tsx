    ...
    return (
        <div className={cn('relative', className)}>
            ...
            <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 rounded p-1 text-muted-foreground transition-colors hover:text-foreground/80 focus:outline-none focus:ring-1 focus:ring-border"
