// Webflow OAuth callback route.
// Handles the redirect from Webflow after the user grants permission.
...
export async function loader({
    ...
    if (error) {
        console.error(
            '[webflow.callback] OAuth error:',
            error,
            errorDescription
        );
        return {
            success: false,
            error: errorDescription || `Webflow OAuth error: ${error}`,
        };
    }
...
export default function WebflowOAuthCallback() {
