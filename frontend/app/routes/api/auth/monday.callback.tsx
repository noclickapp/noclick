// monday.com OAuth callback route.
// Handles the redirect from monday after the user grants permission.
...
export async function loader({
    ...
    if (error) {
        console.error(
            '[monday.callback] OAuth error:',
            error,
            errorDescription
        );
        return {
            success: false,
            error: errorDescription || `monday.com OAuth error: ${error}`,
        };
    }
    ...
    try {
        ...
        console.error('[monday.callback] Failed to decode state:', e);
        return {
            success: false,
...
export default function MondayOAuthCallback() {
