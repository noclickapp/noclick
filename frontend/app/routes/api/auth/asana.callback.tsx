...
// Handles the redirect from Asana after the user grants permission.
...
export async function loader({
    ...
    if (error) {
        console.error('[asana.callback] OAuth error:', error, errorDescription);
        return {
            success: false,
            error: errorDescription || `Asana OAuth error: ${error}`,
        };
    }
    ...
    try {
        ...
        console.error('[asana.callback] Failed to decode state:', e);
        return {
            success: false,
...
export default function AsanaOAuthCallback() {
