// Unified Google OAuth callback route.
// Handles the redirect from Google after user grants permission.
// Works for any Google API (Sheets, Gmail, Drive, etc.) - scope-agnostic.
...
export async function loader({
    ...
    if (error) {
        console.error(
            '[google.callback] OAuth error:',
            error,
            errorDescription
        );
        return {
            success: false,
            error: errorDescription || `Google OAuth error: ${error}`,
        };
    }
