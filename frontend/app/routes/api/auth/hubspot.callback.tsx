...
// Handles the redirect from HubSpot after user grants permission.
...
export async function loader({
    ...
    if (error) {
        console.error(
            '[hubspot.callback] OAuth error:',
            error,
            errorDescription
        );
        return {
            success: false,
            error: errorDescription || `HubSpot OAuth error: ${error}`,
        };
    }
    ...
    try {
        ...
        console.error('[hubspot.callback] Failed to decode state:', e);
        return {
            success: false,
