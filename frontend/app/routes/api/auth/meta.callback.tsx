// Meta (Marketing / Ads / Business) OAuth callback route.
// Handles the redirect from the Facebook Login dialog after the user grants
// permission. Passes the authorization code back to the opener window via
// postMessage (type: meta-oauth-callback).
...
export async function loader({
    ...
    if (error) {
        ...
        return {
            success: false,
            error: errorDescription || `Meta OAuth error: ${error}`,
        };
    }
    ...
    try {
        ...
        console.error('[meta.callback] Failed to decode state:', e);
        return {
            success: false,
