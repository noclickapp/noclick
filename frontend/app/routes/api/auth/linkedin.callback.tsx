...
// Handles the redirect from LinkedIn after user grants permission.
...
export async function loader({
    ...
    if (error) {
        ...
        return {
            success: false,
            error: errorDescription || `LinkedIn OAuth error: ${error}`,
        };
    }
    ...
    try {
        ...
        console.error('[linkedin.callback] Failed to decode state:', e);
        return {
            success: false,
