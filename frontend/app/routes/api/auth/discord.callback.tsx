...
// Handles the redirect from Discord after user grants permission.
...
export async function loader({
    ...
    if (error) {
        console.error(
            '[discord.callback] OAuth error:',
            error,
            errorDescription
        );
        return {
            success: false,
            error: errorDescription || `Discord OAuth error: ${error}`,
        };
    }
    ...
    try {
        ...
        console.error('[discord.callback] Failed to decode state:', e);
        return {
            success: false,
