...
// Handles the redirect from Notion after user grants permission.
...
export async function loader({
    ...
    if (error) {
        console.error(
            '[notion.callback] OAuth error:',
            error,
            errorDescription
        );
        return {
            success: false,
            error: errorDescription || `Notion OAuth error: ${error}`,
        };
    }
    ...
    try {
        ...
        console.error('[notion.callback] Failed to decode state:', e);
        return {
            success: false,
