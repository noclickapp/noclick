...
EVENT_ROUTING: Dict[str, Dict[str, HandlerKey]] = {
    "API": {
        ...
        "instagram_login:oauth:exchange": Handler.INSTAGRAM_LOGIN_OAUTH,
        "instagram_login:oauth:refresh": Handler.INSTAGRAM_LOGIN_OAUTH,
        "instagram_login:oauth:validate": Handler.INSTAGRAM_LOGIN_OAUTH,
