...
SYSTEM_PROMPT = (
    ...
    "plan or credits don't cover something, relay its reason and its 'next' as they are: name the plans that "
    "include it and give the link on its own line, then offer to pick it back up once that's done. Never "
    "shorten that to 'not available'."
