...
SYSTEM_PROMPT = (
    ...
    "returned link. Use credential_connection_status to verify completion. list_credentials and "
    ...
    "relax them through the returned settings link. An approved lookup resumes the original lookup_credential_options "
